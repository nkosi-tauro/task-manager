...
export async function getAllUserTasksHandler (request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    return await reply.code(200).send(tasks)
  } catch (error) {
    return await reply.code(404).send({ error: 'Tasks not found' })
  }
}
...
export async function getAllTasksHandler (request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    return await reply.code(500).send({ error: 'Tasks not found' })
  }
}
...
export async function getTaskByIdHandler (request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    return await reply.code(200).send(task)
  } catch (error) {
    return await reply.code(404).send({ error: 'Task not found' })
  }
}
...
export async function updateTaskHandler (request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    return await reply.code(200).send(updatedTask)
  } catch (error) {
    console.log(error)
    return await reply.code(500).send({ error: 'Failed to update task' })
  }
}
...
export async function deleteTaskHandler (request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    return await reply.code(204).send({ message: 'Task deleted successfully' })
  } catch (error) {
    return await reply.code(500).send({ error: 'Failed to delete task' })
  }
}
...
export async function assignTaskHandler (request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    return await reply.code(500).send({ error: 'Failed to assign task' })
  }
}
...
export async function updateTaskStatusHandler (request: FastifyRequest, reply: FastifyReply) {
  try {
    ...
    return await reply.code(500).send({ error: 'Failed to update task status' })
  }
}
